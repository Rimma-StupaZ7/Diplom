...
1. Скачайте архив с приложением по ссылке https://drive.google.com/drive/u/0/folders/14Sl8CAiIzFqtyXx6BAmWVlbu3_cXXzH1
2. Открыть архив в Android Studio и установите на устройство или эмулятор.
3. Данные для авторизации:
* В поле "Логин" ввести: login2
* В поле "Пароль" ввести: password2

4. Запустить тесты из пакеты, путь: app\src\androidTest\java\ru\iteco\fmhandroid\test
5. запуск всех тестов в проекте на сушествующем устройсте (может быть эмулятор): ./gradlew clean connectedAndroidTest
